...
public class SongAdapter extends BaseAdapter{
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.imvImageSong =  view.findViewById(R.id.imv_item_image_song);
            holder.imvAnimation =  view.findViewById(R.id.imv_animation);
            holder.tvArtist =  view.findViewById(R.id.tv_item_artist_song);
            holder.tvNameSong =  view.findViewById(R.id.tv_item_name_song);
            holder.llMain=  view.findViewById(R.id.ll_item_song);
            view.setTag(holder);
        } else {
